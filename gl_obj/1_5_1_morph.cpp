 ...
 *  gl
 *
 *  Created by Haru (HyunKyung) Ji on 2/05/11.
 *  Copyright 2011 UCSB. All rights reserved.
 *
 *  Error test
 *  Nehe tutorial 11, 25
 *  Specific obj files, vertices + points from Maya + texteditor
 *  To do: Frees The Object (Releasing The Memory)
 */ 
...
{	
	...
	objload("/Users/jiharu/svn/594CM/gl_obj/obj/morph/Sphere.txt",&morph1);						// Load The First Object Into morph1 From File sphere.txt
	objload("/Users/jiharu/svn/594CM/gl_obj/obj/morph/Torus.txt",&morph2);						// Load The Second Object Into morph2 From File torus.txt
	objload("/Users/jiharu/svn/594CM/gl_obj/obj/morph/Tube.txt",&morph3);						// Load The Third Object Into morph3 From File tube.txt
	objallocate(&morph4,468);							// Manually Reserver Ram For A 4th 468 Vertice Object (morph4)
	...
	objload("/Users/jiharu/svn/594CM/gl_obj/obj/morph/Sphere.txt",&helper);						// Load sphere.txt Object Into Helper (Used As Starting Point)
...
*/
	...
	glRotatef(rotX1, .0, 1.0, 0.0); // whole world rotation
	glPushMatrix(); 
   ...
   #pragma mark Morph gl Drawing 3/4
	...
	vec3 q;									// Holds Returned Calculated Values For One VertexglBegin(GL_POINTS);								// Begin Drawing Points
		
	/*
	glEnableClientState(GL_VERTEX_ARRAY);
	glVertexPointer(3, GL_FLOAT, 0, morph1.points);
	glDrawArrays(GL_POINTS, 0, morph1.verts);
	glDisableClientState(GL_VERTEX_ARRAY);
	*/
	...
	{									// The Same Amount Of Verts For Simplicity, Could Use maxver Also)
		...
		glColor3f(1.0,0.,1.0);						// Set Color To A Very Dark Blue
		...
		glColor3f(1.0, 1.0, 1.0);						// Set Color To A Very Dark Blue
