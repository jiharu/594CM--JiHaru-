 ...
 *
 *	Nehe 8 & 9
 *	#pragma mark Blending // 1. Enable Blend, 2. Enable BlendFunc 3. Disable depth test 4. material alpha value	
 */ 
...
*/
	...
	//------------------------------------------------------------Land
	glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, mat_blue);
	glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, mat_green); 
