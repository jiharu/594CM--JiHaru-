 ...
 *  gl
 *
 *  Created by Haru (HyunKyung) Ji on 1/31/11.
 *  Copyright 2011 UCSB. All rights reserved.
 *
 *  Nehe 8 & 9
 *	blendMask 1/2: 1. Enable GL_DEPTH_TEST, 2. TRUE DEPTHMASK 3. DISABLE blend
 * 	blendMask 2/2: 1. Enable blend, 2. Enable BlendFunc 3. False depth mask 4. material alpha value	 
 */ 
...
*/
	...
	glMaterialfv(GL_FRONT, GL_EMISSION, mat_purple); 	
	glutSolidCube(.2);	
	glPopMatrix(); 
	...
	glMaterialfv(GL_FRONT, GL_SPECULAR, mat_white); 
	glMaterialfv(GL_FRONT, GL_SHININESS, low_shininess); 
	glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_purple);
	glMaterialfv(GL_FRONT, GL_EMISSION, mat_purple); 
	glutSolidSphere(0.05, 10, 10);
	glPopMatrix(); 
	//------------------------------------------------------------Blue Sphere
